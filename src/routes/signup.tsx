      ...
      <div className="w-full max-w-sm">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/login" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">Log in</Link>
          </p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="submit" className="gradient-btn w-full !py-3 text-sm">Create account</button>
          <p className="text-center text-xs text-gray-500 dark:text-gray-500">
            By signing up, you agree to our <a href="#" className="underline hover:text-gray-700 dark:hover:text-gray-300">Terms of Service</a> and <a href="#" className="underline hover:text-gray-700 dark:hover:text-gray-300">Privacy Policy</a>
          </p>
        </form>
      </div>
    </div>
